    ...
    <div className="mx-auto mt-6 w-full max-w-md pb-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <p className="font-mono text-[0.625rem] uppercase tracking-wider2 text-bronze">Recent</p>
        </div>
        {items.length > 0 && (
          <Link
            href="/swap/history"
      ...
      {items.length === 0 ? (
        <div className="mt-3 border border-line bg-panel px-4 py-6 text-center">
          <p className="font-mono text-[0.625rem] uppercase tracking-wider2 text-bronze">No transactions yet</p>
        </div>
      ) : (
        <>
          ...
          <Link
            href="/swap/history"
            className="mt-3 flex items-center justify-center gap-1 border border-line px-4 py-2.5 font-mono text-[0.625rem] uppercase tracking-wider2 text-bronze transition-colors hover:border-gold hover:text-goldLight"
          >
            View All
