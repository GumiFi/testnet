    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center px-6">
      ...
      <div className="relative w-full max-w-xs border border-gold/40 bg-panel px-6 py-8 text-center animate-fadeUp">
        ...
        <button
          type="button"
          onClick={onClose}
          className="mt-2 w-full border border-gold px-4 py-2 font-mono text-[0.625rem] uppercase tracking-wider2 text-goldLight transition-colors hover:bg-gold hover:text-void"
        >
          Close
        </button>
      </div>
