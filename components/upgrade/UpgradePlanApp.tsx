      ...
      <div className="mx-auto max-w-5xl px-6 py-16">
        <div className="grid gap-8 md:grid-cols-2">
          <PlanCard
            ...
            footer={
              !isGumiHolder ? (
                <span className="block w-full border border-line px-4 py-3 text-center font-mono text-[0.6875rem] uppercase tracking-wider2 text-bronze">
                  Current Plan
                </span>
              ) : (
                <span className="block w-full border border-line px-4 py-3 text-center font-mono text-[0.6875rem] uppercase tracking-wider2 text-bronze">
            ...
            footer={
              isGumiHolder ? (
                <div className="flex w-full flex-col gap-2">
                  <span className="flex w-full items-center justify-center gap-2 border border-gold bg-gold/10 px-4 py-3 font-mono text-[0.6875rem] uppercase tracking-wider2 text-goldLight">
                  ...
                  <button
                    ...
                    className="w-full border border-line px-4 py-2.5 font-mono text-[0.625rem] uppercase tracking-wider2 text-bronze transition-colors hover:border-gold/40 hover:text-ivory"
                  >
                ...
                <button
                  ...
                  className="w-full border border-gold px-4 py-3 font-mono text-[0.6875rem] uppercase tracking-wider2 text-goldLight transition-colors hover:bg-gold hover:text-void"
                >
                  Mint Your NFT
                </button>
              )
        ...
        <p className="mt-10 flex items-center justify-center gap-2 text-center font-mono text-[0.625rem] uppercase tracking-wider2 text-bronze">
  ...
  return (
    <div
      className={`relative flex flex-col border px-6 py-8 md:px-8 md:py-10 ${
        highlighted
          ? "border-gold bg-gradient-to-b from-panel to-panel2 shadow-[0_0_2.5rem_rgba(201,162,39,0.12)]"
          : "border-line bg-panel"
      }`}
    >
      {highlighted && (
        <span className="absolute -top-3 left-1/2 -translate-x-1/2 border border-gold bg-void px-3 py-1 font-mono text-[0.5625rem] uppercase tracking-wider2 text-goldLight">
          Most Prestigious
        </span>
      )}
      ...
      <p className="mt-1 font-mono text-[0.625rem] uppercase tracking-wider2 text-bronze">{priceNote}</p>
...
function InfoTile({
  ...
  return (
    <div className="border border-line bg-panel p-5">
      ...
      <p className="mt-3 font-mono text-[0.625rem] uppercase tracking-wider2 text-goldLight">{label}</p>
