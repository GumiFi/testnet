import { dexDetailTimeframes, type DexDetailTimeframe } from "@/lib/dex-data";
import { formatPct } from "@/lib/format";

export default function PairTimeframeTabs({
  active,
  onChange,
  changes,
}: {
  active: DexDetailTimeframe;
  onChange: (value: DexDetailTimeframe) => void;
  changes: Record<DexDetailTimeframe, number>;
}) {
  return (
    <div className="grid grid-cols-4 gap-2">
      {dexDetailTimeframes.map((timeframe) => {
