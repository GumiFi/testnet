...
import type { UserLaunch } from "@/lib/user-profile-data";

export default function UserLaunchesSection({ launches }: { launches: UserLaunch[] }) {
  if (launches.length === 0) {
    return (
      <div className="border border-line bg-panel px-4 py-8 text-center">
        <p className="font-mono text-[10px] uppercase tracking-wider2 text-bronze">No launches yet</p>
      </div>
    );
  }
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            ...
            {launch.graduated ? (
              ...
              <p className="mt-0.5 font-mono text-[9px] uppercase tracking-wider2 text-bronze">Live</p>
            )}
          </div>
